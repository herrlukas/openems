...
public class IoShellyPMMiniImpl extends AbstractOpenemsComponent implements IoShellyPMMini, SinglePhaseMeter, 
	...
	private final Logger log = LoggerFactory.getLogger(IoShellyPMMiniImpl.class);
	...
	public IoShellyPMMiniImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				IoShellyPMMini.ChannelId.values() //
		);
	...
	private void activate(ComponentContext context, Config config) {
		...
		cycleService.subscribeJsonEveryCycle(this.baseUrl + "/rpc/PM1.GetStatus?id=0", this::processHttpResult);
	}
	...
	private void processHttpResult(HttpResponse<JsonElement> result, Throwable error) {
		...
		if (error != null) {
			...
			try {
				...
				var switch0 = getAsJsonObject(jsonResponse);
		...
		setValue(this, IoShellyPMMini.ChannelId.NEEDS_RESTART, restartRequired);
	}
