...
import io.openems.edge.solplanet.ess.EssSolplanetImpl;

public class EssSolplanetImplTest {

	@Test
	public void test() throws Exception {
		final var sut = new EssSolplanetImpl();
		...
		new ComponentTest(sut) //
			...
			.next(new TestCase("Successful read response") //
					...
					.onAfterProcessImage(() -> assertEquals("SoC:96 %|L:-386 W", sut.debugLog()))
			...
			.next(new TestCase("Invalid read response")
					...
					.onAfterProcessImage(() -> assertEquals("SoC:UNDEFINED|L:UNDEFINED", sut.debugLog()))
